...
RPCHelpMan sendtoaddress()
{
    return RPCHelpMan{"sendtoaddress",
                "\nSend an amount to a given address (supports PQ/Dilithium and Bitcoin-style addresses)." +
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send to (PQ/Dilithium or Bitcoin-style)."},
