...
std::shared_ptr<CWallet> GetWalletForJSONRPCRequest(const JSONRPCRequest& request)
{
    ...
    throw JSONRPCError(RPC_WALLET_NOT_SPECIFIED,
        "Multiple wallets are loaded. Please select which wallet to use with -rpcwallet=<walletname> or by requesting the RPC through the /wallet/<walletname> URI path.");
}
