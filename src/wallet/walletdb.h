...
extern const std::string DILITHIUM_PUBKEY;
...
//class CWalletDB {
//public:
//    bool WritePQPrivateKey(const std::vector<uint8_t>& priv);
//    bool ReadPQPrivateKey(std::vector<uint8_t>& priv);
//};
...
public:
    ...
    bool WriteDilithiumKey(const CKeyID& keyid, const std::vector<unsigned char>& vchPubKey, const std::vector<unsigned char>& vchPrivKey);
    ...
    bool WriteDilithiumPubKey(const CKeyID& keyID, const std::vector<unsigned char>& vchPubKey);
    ...
    bool WritePQPrivateKey(const std::vector<uint8_t>& key);
