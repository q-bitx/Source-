...
void CBlockPolicyEstimator::FlushFeeEstimates()
{
    ...
    if (est_file.IsNull() || !Write(est_file)) {
        ...
        LogPrintf("Flushed fee estimates to %s.\n", PathToString(m_estimation_filepath.filename()));
    }
}
