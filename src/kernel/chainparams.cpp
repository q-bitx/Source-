...
public:
    CMainParams() {
        ...
        consensus.nPowEmergencyWindow = 5 * 60; // 5 minutes (300 seconds) for testing
        ...
        genesis = CreateGenesisBlock(1744039985, 3492932864, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("00000000d95243b67e1e9ad6642129388be4db92278f2ff584acc1da061976a6"));
        assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});

        // Q-BitX mainnet DNS seeds (empty for now - use addnode for peer discovery)
        // TODO: Add Q-BitX DNS seeds when available (e.g., seed1.qbitx.org, seed2.qbitx.org)
        vSeeds.clear();
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // Q-BitX testnet DNS seeds (empty for now - use addnode for peer discovery)
        // TODO: Add Q-BitX testnet DNS seeds when available
...
{
LogPrintf("[CHAINPARAMS] Main() from kernel/chainparams.cpp\n");
