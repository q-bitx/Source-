...
std::optional<OutputType> ParseOutputType(const std::string& type)
{
    if (type == OUTPUT_TYPE_STRING_LEGACY) {
        ...
        // Alias for dilithium-legacy
        return OutputType::DILITHIUM_LEGACY;
    } else if (type == "pq-bech32") {
        // Alias for dilithium-bech32
        return OutputType::DILITHIUM_BECH32;
    } else if (type == "dilithium") {
        // Default to bech32 for "dilithium"
        return OutputType::DILITHIUM_BECH32;
    } else if (type == "dilithium_legacy") {
        // Alias for dilithium-legacy
        return OutputType::DILITHIUM_LEGACY;
    } else if (type == "dilithium_bech32") {
        // Alias for dilithium-bech32
        return OutputType::DILITHIUM_BECH32;
    }
    return std::nullopt;
