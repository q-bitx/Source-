 ...
 */
const std::string UA_NAME("Q-BitX");
...
//std::string CopyrightHolders(const std::string& strPrefix)
//{
   // const std::string copyright_devs = _(COPYRIGHT_HOLDERS).translated;
 //   std::string strCopyrightHolders = strPrefix + copyright_devs;
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    const std::string copyright_devs = strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION);
    std::string strCopyrightHolders = strPrefix + copyright_devs;
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/q-bitx/mainnet>";
