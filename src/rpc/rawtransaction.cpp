...
static std::vector<RPCArg> CreateTxDoc()
{
    return {
        ...
        {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The outputs specified as key-value pairs or objects with scriptPubKey.\n"
                "Legacy format: array of objects with address/data keys, or dictionary with address/data keys.\n"
                "Each key may only appear once, i.e. there can only be one 'data' output, and no address may be duplicated.\n"
                "New format: array of objects with \"scriptPubKey\" (hex) and \"amount\" fields.\n"
                ...
                "                             accepted as second parameter.",
            {
                ...
                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                    {
                        {"scriptPubKey", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "Hex-encoded scriptPubKey"},
...
static RPCHelpMan createrawtransaction()
{
    return RPCHelpMan{"createrawtransaction",
            ...
            + HelpExampleCli("createrawtransaction", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" \"[{\\\"scriptPubKey\\\":\\\"c04da007...b3\\\",\\\"amount\\\":0.01}]\"")
            + HelpExampleRpc("createrawtransaction", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", \"[{\\\"address\\\":0.01}]\"")
            + HelpExampleRpc("createrawtransaction", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", \"[{\\\"data\\\":\\\"00010203\\\"}]\"")
            + HelpExampleRpc("createrawtransaction", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", \"[{\\\"scriptPubKey\\\":\\\"c04da007...b3\\\",\\\"amount\\\":0.01}]\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
if (!request.params[3].isNull()) {
    sighash = ParseSighashString(request.params[3].get_str());
}
bool complete = SignTransaction(mtx, &keystore, coins, sighash, input_errors);
...
for (const auto& [index, error] : input_errors) {
    ...
    entry.pushKV("input_index", index);
    entry.pushKV("error", error.original);
