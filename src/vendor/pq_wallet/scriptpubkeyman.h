...
#ifndef QBITX_WALLET_SCRIPTPUBKEYMAN_H
#define QBITX_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Q-BitX wallet was originally a collection of unrelated private
...
#endif // QBITX_WALLET_SCRIPTPUBKEYMAN_H
