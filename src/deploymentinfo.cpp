...
std::string DeploymentName(Consensus::BuriedDeployment dep)
{
    ...
    case Consensus::DEPLOYMENT_SEGWIT:
        return "segwit";
    case Consensus::DEPLOYMENT_PQ_SIGOPS:
        return "pq_sigops";
    case Consensus::DEPLOYMENT_PQ_WITNESS:
        return "pq_witness";
...
std::optional<Consensus::BuriedDeployment> GetBuriedDeployment(const std::string_view name)
{
    ...
    } else if (name == "pq_sigops") {
        return Consensus::BuriedDeployment::DEPLOYMENT_PQ_SIGOPS;
    } else if (name == "pq_witness") {
        return Consensus::BuriedDeployment::DEPLOYMENT_PQ_WITNESS;
    } else if (name == "bip34") {
