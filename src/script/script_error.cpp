...
std::string ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_PQCHECKSIGVERIFY: return "Script failed an OP_PQCHECKSIGVERIFY operation";
        case SCRIPT_ERR_PQCHECKSIG: return "Script failed an OP_PQCHECKSIG operation";
