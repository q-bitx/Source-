...
public:
    ...
    virtual bool GetDilithiumKeyByHash(const DilithiumPKHash& address, std::vector<unsigned char>& key_bytes) const { return false; }
...
public:
    ...
    bool GetDilithiumKeyByHash(const DilithiumPKHash& address, std::vector<unsigned char>& key_bytes) const override;
...
struct FlatSigningProvider final : public SigningProvider
{
    ...
    std::map<DilithiumPKHash, std::vector<unsigned char>> dilithium_keys;
