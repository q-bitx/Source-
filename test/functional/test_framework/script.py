...
# Q-BitX PQ opcodes
OP_PQCHECKSIG = CScriptOp(0xc1)
OP_PQCHECKSIGVERIFY = CScriptOp(0xc2)
OP_PQCHECKSIGADD = CScriptOp(0xc3)
OP_CHECKSIGDILITHIUM = CScriptOp(0xc4)
OP_CHECKSIGDILITHIUMVERIFY = CScriptOp(0xc5)
OP_CHECKMULTISIGDILITHIUM = CScriptOp(0xc6)
OP_CHECKMULTISIGDILITHIUMVERIFY = CScriptOp(0xc7)
